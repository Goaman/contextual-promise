...
// Usage: node test/test.js [path-to-implementation]   (default: ../cancellablePromise.js)
const path = require('path');
globalThis.window = globalThis;
require(process.argv[2] ? path.resolve(process.argv[2]) : path.join(__dirname, '..', 'cancellablePromise.js'));
